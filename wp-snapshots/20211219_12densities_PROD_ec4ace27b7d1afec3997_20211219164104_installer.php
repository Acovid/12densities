...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20211219_12densities_PROD_ec4ace27b7d1afec3997_20211219164104_archive.zip';
	const ARCHIVE_SIZE		 = '3027393';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'ec4ace2-19164104';
    const SECONDARY_PACKAGE_HASH = '97f5815-19164104';
	const VERSION			 = '1.4.0';
