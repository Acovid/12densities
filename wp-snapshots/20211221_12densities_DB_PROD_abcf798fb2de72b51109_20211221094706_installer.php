...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20211221_12densities_DB_PROD_abcf798fb2de72b51109_20211221094706_archive.zip';
	const ARCHIVE_SIZE		 = '3199904';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'abcf798-21094706';
    const SECONDARY_PACKAGE_HASH = '1a92d43-21094706';
	const VERSION			 = '1.4.3';
