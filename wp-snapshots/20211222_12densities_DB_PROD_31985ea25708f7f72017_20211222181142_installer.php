...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20211222_12densities_DB_PROD_31985ea25708f7f72017_20211222181142_archive.zip';
	const ARCHIVE_SIZE		 = '3192044';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '31985ea-22181142';
    const SECONDARY_PACKAGE_HASH = 'f1467ba-22181142';
	const VERSION			 = '1.4.3';
